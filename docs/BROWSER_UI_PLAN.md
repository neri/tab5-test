...
| 8 | `text/plain`ほかの`text/*`の表示 | 実装完了、実機未確認 |
| 9 | `file:`スキーム | 実装完了、実機確認済み |
| 10 | 本文の余白8 px、Wi-Fiインジケーター | 実装完了、実機未確認 |
...
| Stage | 内容 | 状態 |
| --- | --- | --- |
| 8 | `text/plain`ほかの`text/*`を表示する | 完了（ホスト試験済み） |
| 9 | `file:`スキーム | 完了（ホスト試験済み、**実機未確認**） |
