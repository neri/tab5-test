...
- [`BOOT.md`](BOOT.md)の起動・イメージ配置、RAM範囲、実測セクションサイズ
- [`FILE_LAYOUT.md`](FILE_LAYOUT.md)のファイル構成と
  [`DIAGNOSTICS.md`](DIAGNOSTICS.md)の起動ログ例
...
- `BOOT.md`、`DIAGNOSTICS.md`と本計画に最終配置、実測サイズ、実機結果が反映されている
