...
//!   actual `docs/plans/archive/USB_HOST_PLAN.md` Stage 3 milestone.
...
//!   `docs/plans/archive/USB_REFACTOR_PLAN.md`.
//!
//! Staged per `docs/plans/archive/USB_HOST_PLAN.md`: `hcd::probe_port` is Stage 1,
...
//! `msc` follows `docs/plans/archive/USB_MSC_PLAN.md`. `registry` follows `docs/plans/archive/USB_REFACTOR_PLAN.md`,
...
pub use hcd::{
    ...
    cache_direction_names, cache_refusal_count, cache_site_names, fifo_configuration, fifo_names,
    force_cache_refusals, force_fifo_flush_timeouts, force_short_outs, force_stale_completions,
    fs_ls_only_host_forced, host_observation, interrupt_diagnostics, packet_failure_kind_index,
    packet_failure_kind_names, pi4ioe2_register, port_drop_seen, port_event_history,
    port_over_current_seen, probe_split_support, set_connect_wait_ms, set_fs_ls_only_host_forced,
    set_pi4ioe2_output_bit, set_vbus_bit, set_vbus_power, transfer_label_names,
};
