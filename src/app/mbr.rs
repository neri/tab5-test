...
//! `usbmbr` commands (`docs/plans/archive/USB_MSC_PLAN.md` Stage 6, the goal of that plan:
...
//! out of scope, same as `docs/plans/archive/SD_CARD_PLAN.md`'s Stage 4a originally was).
